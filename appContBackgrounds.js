let b = new Bump(PIXI);
let appBackgroundContainer = new PIXI.Container();
...
function setup() {
    ...
    appBackgroundContainer.ticker.add(delta => GameLoop(delta));

    appBackgroundContainer.stage.addChild(inputDetectionBox);
...
function SetupBackgroundLevel() {
    ...
    for (var i = 0; i < numberOfBackgroundTilesToLoad; i++) 
    {
        ...
        appBackgroundContainer.stage.addChild(tempBackgroundSprite);
        ...
        appBackgroundContainer.stage.addChild(tempBoundarySprite);
        ...
        appContainer.stage.addChild(tempEnemies21);
